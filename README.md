...
# Setting up zpsend:asker workspace
- Below is the a script to setup a zpsender:asker workspace
...
# Setting up zpsend:receiver workspace
- Below is the a script to setup a zpsender:receiver workspace
